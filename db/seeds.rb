...
seats = [
  ...
  { id: 2, location_id: 2, location_type: 'smbc_seat', seat_name: "smbc_seat", spots: [ { lat: 34.72187874116491, lng: 135.36179821195276 }, { lat: 34.7214670896035, lng: 135.36214140786504 }, { lat: 34.72154942007975, lng: 135.36226949055 }, { lat: 34.72196916926612, lng: 135.36191972629493 }] },
  { id: 3, location_id: 3, location_type: 'ivy_seat', seat_name: "ivy_seat", spots: [{ lat: 34.72156156719225, lng: 135.3605354480459 }, { lat: 34.72139420681841, lng: 135.36107241007133 },{ lat: 34.72185309735701, lng: 135.3613384279555 }, { lat: 34.72207309397672, lng: 135.36079325550156 }] },
  { id: 4, location_id: 4, location_type: 'breeze_seat', seat_name: "breeze_seat", spots:  [{ lat: 34.721971868610915, lng: 135.36193122089486 }, { lat: 34.7215386226449, lng: 135.36226949055 }, { lat: 34.72168438789625, lng: 135.3626340335764 }, { lat: 34.72215947285756, lng: 135.36226784846428 }] },
  { id: 5, location_id: 5, location_type: 'first_base_alps', seat_name: "first_base_alps", spots: [{ lat: 34.721562916864194, lng: 135.3605453005603 }, { lat: 34.721009546603405, lng: 135.36037616573273 }, { lat: 34.72095150999563, lng: 135.36091969610092 }, { lat: 34.72138475903816, lng: 135.36104777878592 }]},
  { id: 6, location_id: 6, location_type: 'third_base_alps', seat_name: "third_base_alps", spots: [{ lat: 34.721448194066305, lng: 135.36218574417896 }, { lat: 34.72106083473515, lng: 135.36242384660613 }, { lat: 34.72117690775651, lng: 135.36290005146049 }, { lat: 34.72168978659783, lng: 135.36263567566203 }] },
  { id: 7, location_id: 7, location_type: 'right_outfield', seat_name: "right_outfield", spots: [{ lat: 34.72100954659191, lng: 135.3604057232753 }, { lat: 34.72046427080976, lng: 135.36078668715876 }, { lat: 34.72033604949718, lng: 135.36160937209678 }, { lat: 34.72069641836452, lng: 135.36157981455412 }, { lat: 34.72075715453582, lng: 135.36117257729936 }, { lat: 34.7209744546944, lng: 135.36091476984373 }] },
  { id: 8, location_id: 8, location_type: 'left_outfield', seat_name: "left_outfield", points: [{ lat: 34.720709745341196, lng: 135.3617563256627 }, { lat: 34.72038671554692, lng: 135.3618378628127 }, { lat: 34.72052611445111, lng: 135.36266301877117 }, { lat: 34.72114670479741, lng: 135.3628505542163 }, { lat: 34.72105287934201, lng: 135.36237763874604 }, { lat: 34.720822336342174, lng: 135.3621477039829 }] },
...
matches = [
  ...
  { match_date: '2024-08-02 18:00', opponent: Match.opponents[:DeNA], stadium: "yokohama", result: 1, team_score: 4, away_team_score: 2 },
  { match_date: '2024-08-03 18:00', opponent: Match.opponents[:DeNA], stadium: "yokohama", result: 1, team_score: 4, away_team_score: 10 },
  { match_date: '2024-08-04 18:00', opponent: Match.opponents[:DeNA], stadium: "yokohama", result: 0, team_score: 4, away_team_score: 0 },
  { match_date: '2024-08-06 18:00', opponent: Match.opponents[:ヤクルト], stadium: "jingu", result: 1, team_score: 4, away_team_score: 5 },
  { match_date: '2024-08-07 18:00', opponent: Match.opponents[:ヤクルト], stadium: "jingu", result: 1, team_score: 0, away_team_score: 4 },
  { match_date: '2024-08-08 18:00', opponent: Match.opponents[:ヤクルト], stadium: "jingu", result: 0, team_score: 6, away_team_score: 3 },
  { match_date: '2024-08-09 18:00', opponent: Match.opponents[:広島], stadium: "kyosera", result: 1, team_score: 3, away_team_score: 6 },
  { match_date: '2024-08-10 18:00', opponent: Match.opponents[:広島], stadium: "kyosera", result: 1, team_score: 1, away_team_score: 5 },
  { match_date: '2024-08-11 18:00', opponent: Match.opponents[:広島], stadium: "kyosera", result: 0, team_score: 4, away_team_score: 0 },
  { match_date: '2024-08-12 18:00', opponent: Match.opponents[:巨人], stadium: "tokyo", result: 1, team_score: 0, away_team_score: 1 },
  { match_date: '2024-08-13 18:00', opponent: Match.opponents[:巨人], stadium: "tokyo", result: 0, team_score: 8, away_team_score: 5 },
  { match_date: '2024-08-14 18:00', opponent: Match.opponents[:巨人], stadium: "tokyo", result: 1, team_score: 0, away_team_score: 4 },
  { match_date: '2024-08-16 18:00', opponent: Match.opponents[:中日], stadium: "nagoya", result: 1, team_score: 1, away_team_score: 2 },
  { match_date: '2024-08-17 14:00', opponent: Match.opponents[:中日], stadium: "nagoya", result: 3, team_score: 5, away_team_score: 5 },
  { match_date: '2024-08-18 13:30', opponent: Match.opponents[:中日], stadium: "nagoya", result: 1, team_score: 4, away_team_score: 8 },
  { match_date: '2024-08-20 18:00', opponent: Match.opponents[:ヤクルト], stadium: "kyosera", result: 0, team_score: 8, away_team_score: 3 },
  { match_date: '2024-08-21 18:00', opponent: Match.opponents[:ヤクルト], stadium: "kyosera", result: 0, team_score: 10, away_team_score: 4 },
  { match_date: '2024-08-22 18:00', opponent: Match.opponents[:ヤクルト], stadium: "kyosera", result: 1, team_score: 2, away_team_score: 5 },
  { match_date: '2024-08-23 18:00', opponent: Match.opponents[:広島], stadium: "mazda", result: 0, team_score: 3, away_team_score: 1 },
  { match_date: '2024-08-24 18:00', opponent: Match.opponents[:広島], stadium: "mazda", result: 1, team_score: 1, away_team_score: 2 },
  { match_date: '2024-08-25 18:00', opponent: Match.opponents[:広島], stadium: "mazda", result: 0, team_score: 7, away_team_score: 5 },
  { match_date: '2024-08-27 18:00', opponent: Match.opponents[:DeNA], stadium: "yokohama", result: 1, team_score: 4, away_team_score: 10 },
  { match_date: '2024-08-28 18:00', opponent: Match.opponents[:DeNA], stadium: "yokohama", result: 1, team_score: 2, away_team_score: 3 },
  ...
  { match_date: '2024-09-06 18:00', opponent: Match.opponents[:ヤクルト], stadium: "jingu", result: 0, team_score: 9, away_team_score: 1 },
  { match_date: '2024-09-07 18:00', opponent: Match.opponents[:ヤクルト], stadium: "jingu", result: 0, team_score: 6, away_team_score: 0 },
  { match_date: '2024-09-08 17:00', opponent: Match.opponents[:ヤクルト], stadium: "jingu", result: 1, team_score: 3, away_team_score: 5 },
  ...
  { match_date: '2024-09-18 18:00', opponent: Match.opponents[:中日], stadium: "nagoya", result: 0, team_score: 8, away_team_score: 3 },
  { match_date: '2024-09-20 18:00', opponent: Match.opponents[:DeNA], stadium: "yokohama", result: 1, team_score: 6, away_team_score: 9 },
  { match_date: '2024-09-21 18:00', opponent: Match.opponents[:DeNA], stadium: "yokohama", result: 0, team_score: 6, away_team_score: 5 },
  ...
  { match_date: '2024-09-27 18:00', opponent: Match.opponents[:広島], stadium: "mazda", result: 0, team_score: 1, away_team_score: 0 },
  { match_date: '2024-09-28 18:00', opponent: Match.opponents[:ヤクルト], stadium: "jingu", result: 0, team_score: 1, away_team_score: 0 },
  { match_date: '2024-09-29 18:00', opponent: Match.opponents[:DeNA] },
  { match_date: '2024-09-30 18:00', opponent: Match.opponents[:DeNA] },
