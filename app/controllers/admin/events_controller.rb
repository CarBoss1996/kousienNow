...
module Admin
  class EventsController < Admin::BaseController
    ...
    def destroy
      ...
      respond_to do |format|
        format.turbo_stream do
          redirect_to admin_events_path, success: I18n.t('defaults.flash_message.delete', item: Event.model_name.human),
                                         status: :see_other
        end
        format.html do
          redirect_to admin_events_path, success: I18n.t('defaults.flash_message.delete', item: Event.model_name.human)
    ...
    def event_params
      params.require(:event).permit(:title, :body, :detail_url, event_dates_attributes: %i[start_date end_date])
    end
  end
end
