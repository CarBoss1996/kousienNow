...
<h2>■このアプリでできること</h2>
<ul>
    <li>アイコン付きでの位置情報の登録</li>
    <li>虎に熱い応援を送られる投稿機能</li>
    <li>ユーザーの投稿にいいねやコメントができる</li>
    <li>対戦カレンダーで試合日程の確認や自分の観戦予定、観戦履歴がわかる！</li>
    <li>マイページから通知設定を行えば、コメントが来た場合にLINEに通知が送られる</li>
</ul>
<br>
